...
const formulare = [
  { 
    title: "Anmeldung Schmutzwasser", 
    file: "Anmeldung Schmutzwasser.pdf" 
  }
];

const merkblaetter = [
  { 
    title: "Merkblatt Hausanschluss Schmutzwasser", 
    file: "Merkblatt Hausanschluss Schmutzwasser.pdf" 
  },
  { 
    title: "Entsorgungsfirmen im Verbandsgebiet", 
    file: "Entsorgungsfirmen.pdf" 
  },
  { 
    title: "Kundeninformation Rückstau allgemein", 
    file: "Kundeninformation Rückstau allgemein.pdf" 
  },
  { 
    title: "Kundeninformation Rückstauverschlüsse", 
    file: "Kundeninformation Rückstauverschlüsse.pdf" 
  },
  { 
    title: "Kundeninformation Abwasserhebeanlagen", 
    file: "Kundeninformation Abwasserhebeanlagen.pdf" 
  }
];

export default function SchmutzwasserFormularePage() {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6 w-full flex-grow mb-24">
        ...
        <header className="mb-12">
          ...
          <p className="text-lg text-slate-600 leading-relaxed max-w-3xl">
            Hier finden Sie alle Anträge, Formulare und technischen Merkblätter rund um die Schmutzwasserentsorgung.
          </p>
        </header>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {formulare.map((doc, index) => (
              ...
              >
                ...
                <a 
                  href={`/service/formulare/schmutzwasser/${doc.file}`}
                  target="_blank"
                  download
