...
const documents = [
  { 
    title: "Satzung zur Abschaffung der Beiträge für die öffentliche Wasserversorgungsanlage", 
    date: "2012-11-20", 
    file: "Satzung zur Abschaffung der Beiträge für die öffentlichen Wasserversorgungsanlage vom 20.11.2012.pdf" 
  },
  { 
    title: "Trinkwasserbeitragssatzung (Ursprungsfassung)", 
    date: "2012-03-20", 
    file: "Trinkwasserbeitragssatzung vom 20.03.2012.pdf" 
  }
];

export default function TrinkwasserBeitragPage() {
      ...
      <div className="max-w-[1200px] mx-auto px-6 w-full flex-grow mb-24">
        ...
        <header className="mb-12">
          ...
          <p className="text-lg text-slate-600 leading-relaxed max-w-3xl">
            Hier finden Sie die Satzungen zur Erhebung von Anschlussbeiträgen für die Trinkwasserversorgung sowie deren Abschaffung.
          </p>
        </header>
        ...
        <div className="grid gap-4">
          {sortedDocs.map((doc, index) => (
            ...
            >
              ...
              <a 
                href={`/service/satzung/trinkwasser/beitrag/${doc.file}`}
                target="_blank"
                download
