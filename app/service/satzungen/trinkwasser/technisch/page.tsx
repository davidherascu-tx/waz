...
const documents = [
  { 
    title: "3. Änderung der Wasserversorgungssatzung", 
    date: "2023-07-18", 
    file: "3. Änderung der Wasserversorgungssatzung des WAZ vom 18.07.2023.pdf" 
  },
  { 
    title: "2. Änderung der Wasserversorgungssatzung", 
    date: "2022-09-20", 
    file: "2. Änderung der Wasserversorgungssatzung des WAZ vom 20.09.2022.pdf" 
  },
  { 
    title: "1. Änderung der Wasserversorgungssatzung", 
    date: "2021-09-20", 
    file: "1. Änderung der Wasserversorgungssatzung des WAZ vom 20.09.2021.pdf" 
  },
  { 
    title: "Wasserversorgungssatzung (Ursprungsfassung)", 
    date: "2018-11-20", 
    file: "Wasserversorgungssatzung des WAZ vom 20.11.2018.pdf" 
  }
];

export default function TrinkwasserTechnischPage() {
      ...
      <div className="max-w-[1200px] mx-auto px-6 w-full flex-grow mb-24">
        ...
        <header className="mb-12">
          ...
          <p className="text-lg text-slate-600 leading-relaxed max-w-3xl">
            Hier finden Sie die Wasserversorgungssatzung, welche die technischen Bedingungen für den Anschluss und die Versorgung regelt.
          </p>
        </header>
        ...
        <div className="grid gap-4">
          {sortedDocs.map((doc, index) => (
            ...
            >
              ...
              <a 
                href={`/service/satzung/trinkwasser/technisch/${doc.file}`}
                target="_blank"
                download
