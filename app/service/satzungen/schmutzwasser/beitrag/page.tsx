// app/service/satzungen/schmutzwasser/beitrag/page.tsx
...
export const metadata: Metadata = pageMetadata({
  title: 'Beitragssatzung Schmutzwasser',
  description:
    'Satzungen zur Erhebung von Beiträgen für die öffentliche Schmutzwasseranlage des WAZ Blankenfelde-Mahlow.',
  path: '/service/satzungen/schmutzwasser/beitrag',
});

const documents = [
  { 
    title: "2. Änderung der Satzung über die Erhebung von Beiträgen für die öffentliche Schmutzwasseranlage", 
    date: "2022-09-20", 
    file: "2. Änderung über die Erhebung von Beiträgen für die öffentliche Schmutzwasseranlage des WAZ vom 20.09.2022.pdf" 
  },
  { 
    title: "1. Änderung der Schmutzwasserbeitragssatzung", 
    date: "2015-09-15", 
    file: "1. Änderung der Schmutzwasserbeitragssatzung des WAZ vom 15.09.2015.pdf" 
  },
  { 
    title: "Schmutzwasserbeitragssatzung (Ursprungsfassung)", 
    date: "2014-10-21", 
    file: "Schmutzwasserbeitragssatzung vom 21.10.2014.pdf" 
  }
];

export default function SchmutzwasserBeitragPage() {
      ...
      <div className="max-w-[1200px] mx-auto px-6 w-full flex-grow mb-24">
        ...
        <header className="mb-12">
          ...
          <p className="text-lg text-slate-600 leading-relaxed max-w-3xl">
            Hier finden Sie die Satzungen zur Erhebung von Beiträgen für die öffentliche Schmutzwasseranlage.
          </p>
        </header>
        ...
        <div className="grid gap-4">
          {sortedDocs.map((doc, index) => (
            ...
            >
              ...
              <a 
                href={`/service/satzung/schmutzwasser/beitrag/${doc.file}`}
                target="_blank"
                download
