...
const documents = [
  { 
    title: "2. Änderung der Entwässerungssatzung", 
    date: "2022-09-20", 
    file: "2. Änderung der Entwässerungssatzung vom 20.09.2022.pdf" 
  },
  { 
    title: "Satzung zur dezentralen Schmutzwasserbeseitigung", 
    date: "2022-04-19", 
    file: "Satzung zur dezentralen Schmutzwasserbeseitigung vom 19.04.2022.pdf" 
  },
  { 
    title: "1. Änderung der Entwässerungssatzung", 
    date: "2021-09-20", 
    file: "1. Änderung der Entwässerungssatzung vom 20.09.2021.pdf" 
  },
  { 
    title: "Entwässerungssatzung (Ursprungsfassung)", 
    date: "2018-11-20", 
    file: "Entwässerungssatzung vom 20.11.2018.pdf" 
  }
];

export default function SchmutzwasserTechnischPage() {
      ...
      <div className="max-w-[1200px] mx-auto px-6 w-full flex-grow mb-24">
        ...
        <header className="mb-12">
          ...
          <p className="text-lg text-slate-600 leading-relaxed max-w-3xl">
            Hier finden Sie die Entwässerungssatzung sowie die Satzung für die dezentrale Schmutzwasserbeseitigung, welche die technischen Bedingungen regeln.
          </p>
        </header>
        ...
        <div className="grid gap-4">
          {sortedDocs.map((doc, index) => (
            ...
            >
              ...
              <a 
                href={`/service/satzung/schmutzwasser/technisch/${doc.file}`}
                target="_blank"
                download
